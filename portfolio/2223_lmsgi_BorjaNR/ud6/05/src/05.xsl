        ...
        <html>
            <head>
                <xsl:call-template name="metaweb">
                        ...
                        <xsl:with-param name="autor" select="'Borja NR'"/>
            ...
            <body>
                <header>
                    ...
                    <h3><xsl:value-of select="concat('Fecha: ',//dia,' de ',document('../data/meses.xml')/meses/mes[@id=current()//mes]/text(),' de ',//anyo)"/></h3>
                </header>
                <main>
                    <form method="get" action="#enviarExamen.php"><div class="contenido">
        ...
        <xsl:param name="idPregunta"/>
            <label>
                <xsl:attribute name="for">
                    <xsl:value-of select="concat('var', $idPregunta,position())"/>
                </xsl:attribute>
                <input type="radio">
