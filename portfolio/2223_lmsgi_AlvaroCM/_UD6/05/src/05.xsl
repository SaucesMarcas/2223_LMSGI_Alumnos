...
<!--
    Document   : 05.xsl
    Created on : 02 de mayo de 2023, 16:30
        ...
        <html>
            <head>
                <xsl:call-template name="metaweb">
                    <xsl:with-param name="descripcion" select="'Crea un formulario a partir de un XML'"/>
                    <xsl:with-param name="autor" select="'Alvaro Cordero Miñambres'"/>
